...
function handlePageChange(sectionKey, direction, animate = true) {
    ...
    document.getElementById(`${sectionKey}-prev-btn`).disabled = state.currentPage === 1;
    document.getElementById(`${sectionKey}-next-btn`).disabled = state.currentPage === state.totalPages;
}
...
function setupPopups() {
    ...
    // Popups that are NOT static in the HTML are generated here
    const popupsData = [
        // Skill Popups
